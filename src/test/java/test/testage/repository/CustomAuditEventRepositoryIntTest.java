package test.testage.repository;

import test.testage.JhipsterSampleApplicationApp;
import test.testage.config.Constants;
import test.testage.config.audit.AuditEventConverter;
import test.testage.domain.PersistentAuditEvent;
...
import static test.testage.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
