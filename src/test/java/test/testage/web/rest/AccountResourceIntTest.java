package test.testage.web.rest;

import test.testage.config.Constants;
import test.testage.JhipsterSampleApplicationApp;
import test.testage.domain.Authority;
import test.testage.domain.User;
import test.testage.repository.AuthorityRepository;
import test.testage.repository.UserRepository;
import test.testage.security.AuthoritiesConstants;
import test.testage.service.MailService;
import test.testage.service.dto.UserDTO;
import test.testage.web.rest.errors.ExceptionTranslator;
import test.testage.web.rest.vm.KeyAndPasswordVM;
import test.testage.web.rest.vm.ManagedUserVM;
import test.testage.service.UserService;
